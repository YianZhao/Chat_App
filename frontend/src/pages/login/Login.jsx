      ...
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form>
          ...
          <label className='label p-2'>
              ...
              <input type='password' placeholder='Enter username' className='w-full input input-bordered h-10'></input>            
          <div>
          ...
          <div>
            <button className='btn btn-block btn-sm mt-2 bg-white'>Login</button>
          </div>
